...
<body>
    ...
    <main class="menu_representante">
        ...
        <div class="menu_representante_mainConsultar">
            <div class="menu_representante_main_consultar">
                <div class="menu_representante_main_consultar_title">
                    <h2>Agenda diaria</h2>
                </div>
                <sql:query var="pacientesDiarios" dataSource="${bd}">
                SELECT u.fase, u.identificacion, u.nombre, u.apellido, u.tipo_documento, c.fecha, c.hora, c.dosis, c.entidad_salud
